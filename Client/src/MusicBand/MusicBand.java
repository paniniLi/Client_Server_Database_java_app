...
public class MusicBand implements Comparable<MusicBand>, Serializable {
    ...
    public MusicBand(String name, Coordinates coordinates, Integer numberOfParticipants, MusicGenre genre, Album bestAlbum, String username){
        this.name = name;
    ...
    private void setUsername(String username) {
     ...
     public String toString() {
        ...
        info.append("MusicBand.MusicBand №").append(this.id).append(":\n");
